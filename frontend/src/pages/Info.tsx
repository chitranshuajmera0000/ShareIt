...
//     const [image, setImage] = useState<string>("");  // New state for image
...
//             if (image) {
//                 formData.append("profileUrl", image);  // Append image to FormData
//             }
...
//             console.log(error)
//             setAlertMessage("An error occurred while publishing the blog. Please try again.");
//             setShowAlert(true);
//         } finally {
//             setIsLoading(false);
//         }
...
//                 <h2 className="flex justify-center text-3xl font-bold mb-4">User Information</h2>
//                 <div onSubmit={handleSubmit} className="space-y-4">
//                     <div className="flex justify-center mb-4 relative">
//                         <label className="relative cursor-pointer">
//                             <input type="file" className="hidden" onChange={handleImageChange} accept="image/*" />
//                             <div className="w-48 h-48 rounded-full border flex items-center justify-center overflow-hidden bg-gray-200 relative">
//                                 {loading ? (
//                                     <div className="w-12 h-12 border-4 border-gray-300 border-t-blue-500 rounded-full animate-spin"></div>
//                                 ) : imagePreview ? (
//                                     <img src={imagePreview} alt="Profile" className="w-full h-full object-cover" />
//                                 ) : (
//                                     <img src={Camera} className="h-20 w-20" />
//                                 )}
//                             </div>
//                             <div className="flex justify-center pt-2 text-lg font-semibold">Profile Photo</div>
//                         </label>
//                     </div>
...
//                                 className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-200 focus:border-blue-200 block p-2.5 w-full"
//                             />
//                         </div>
//                     </div> */}
...
//                             className="w-full p-2 border bg-slate-100 rounded-md focus:ring focus:ring-blue-200"
//                             required
//                         />
//                     </div>
//                     <div>
//                         <label className="block text-md font-medium text-gray-700">Profession</label>
//                         <input
//                             type="text"
//                             name="profession"
...
//                     </div>
//                     <div>
//                         <label className="block text-md  font-medium text-gray-700">About</label>
//                         <textarea
//                             name="about"
...
//     return (
//         <div className="bg-gradient-to-br from-blue-50 to-indigo-100 w-full min-h-screen py-10 flex justify-center p-2 items-center">
//             <div
//                 id="info-container"
//                 className="w-full md:w-2/3 lg:w-1/2 bg-white rounded-xl shadow-lg transition-all duration-500 opacity-0 transform hover:shadow-xl"
//             >
//                 <div className="w-full h-2 bg-gray-200 rounded-t-xl overflow-hidden">
//                     <div
...
//                 <div className="p-8">
//                     <h2 className="text-3xl font-bold mb-6 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-indigo-600">
//                         User Information
//                     </h2>

//                     {showAlert && (
//                         <div
//                             className={`p-3 mb-5 rounded-lg text-center text-white font-medium animate-fadeIn ${alertType === "error" ? "bg-red-500" : "bg-green-500"
//                                 }`}
//                         >
//                             {alertMessage}
//                         </div>
...
//                             >
//                                 <input type="file" className="hidden" onChange={handleImageChange} accept="image/*" />
//                                 <div className="w-40 h-40 md:w-48 md:h-48 rounded-full border-4 border-blue-100 flex items-center justify-center overflow-hidden bg-gray-50 relative transition-all duration-300 hover:shadow-xl">
//                                     {loading ? (
//                                         <div className="w-12 h-12 border-4 border-gray-300 border-t-blue-500 rounded-full animate-spin"></div>
//                                     ) : imagePreview ? (
//                                         <img src={imagePreview} alt="Profile" className="w-full h-full object-cover" />
...
//                                     value={name}
//                                     onChange={(e) => setName(e.target.value)}
//                                     className="w-full p-3 border bg-gray-50 rounded-lg focus:ring-2 focus:ring-blue-300 focus:outline-none focus:bg-white transition-all"
...
//                                 onClick={handleSubmit}
//                                 disabled={isLoading}
//                                 className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-3 px-6 rounded-lg font-medium shadow-md hover:shadow-lg transition-all duration-300 hover:from-blue-600 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 disabled:opacity-70"
//                             >
//                                 {isLoading ? (
