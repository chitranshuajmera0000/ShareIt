...
// import { ChevronRight, Edit3, Zap, Layout, Share2, Users, Play } from "lucide-react";
...
//       className="bg-white rounded-2xl p-6 border border-teal-100 shadow-md transition-all duration-300 h-full"
//     >
//       <div className="rounded-full bg-teal-100 w-12 h-12 flex items-center justify-center text-teal-600 mb-4">
//         {icon}
//       </div>
...
//         {[...Array(5)].map((_, i) => (
//           <svg key={i} className="w-5 h-5 text-coral-400" fill="currentColor" viewBox="0 0 20 20">
...
//                 <a href="#features" className="text-teal-600 hover:text-teal-800 font-medium">Features</a>
//                 <a href="#testimonials" className="text-teal-600 hover:text-teal-800 font-medium">Testimonials</a>
//                 <a href="#faq" className="text-teal-600 hover:text-teal-800 font-medium">FAQ</a>
//               </nav>
//             </div>
...
//                 className="group text-green-400 bg-coral-500 hover:bg-coral-600  px-8 py-4 rounded-xl font-medium text-lg shadow-lg hover:shadow-xl transition flex items-center justify-center space-x-2"
//               >
...
//       <section className="py-16 bg-teal-50" id="demo">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="text-center mb-16">
//             <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Powerful Rich Text Editor</h2>
...
//               </div>
//               <div className="ml-4 text-gray-700 font-medium">New Blog Post</div>
//             </div>
//             <div className="p-4 md:p-8 min-h-64">
//               <div className="flex flex-wrap mb-6 bg-teal-100 p-2 rounded-lg text-sm text-gray-600 cursor-pointer">
//                 <div className="px-3 py-1 rounded-md bg-white shadow-sm">B</div>
//                 <div className="px-3 py-1">I</div>
//                 <div className="px-3 py-1">U</div>
//                 <div className="px-3 py-1">H1</div>
//                 <div className="px-3 py-1">H2</div>
...
//       <section className="py-20 bg-purple-50" id="testimonials">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="text-center mb-16">
...
//             />
//             <Testimonial
//               content="As a tech writer, I need reliable tools. ShareIt's code embedding and syntax highlighting features are perfect for my tutorials."
//               author="Michael Chen"
//               role="Developer & Writer"
//               avatar="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMt0ZBJLBA8kZDvhMjBkQlDDpr55lFcXO5cg&s"
//             />
//             <Testimonial
//               content="I switched to ShareIt from WordPress and never looked back. It's faster, cleaner, and gives me more control over my content."
...
//       {/* CTA Section */}
//       <section className="py-20 bg-gradient-to-r from-teal-600 to-coral-600 text-white">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
//           <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to Start Blogging?</h2>
...
//           <button
//             onClick={() => navigate("/signup")}
//             className="bg-white text-teal-600 hover:text-teal-700 px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition transform hover:-translate-y-1"
//           >
...
//               }
//             ].map((item, i) => (
//               <div key={i} className="border-b border-teal-200 pb-6">
...
//                   src="https://res.cloudinary.com/dxj9gigbq/image/upload/v1742018435/upscalemedia-transformed_woy6ow.png"
//                   alt="ShareIt Logo"
//                   className="h-16 w-25 rounded-md my-2.5"
//                 />
//               </div>
...
//                 <li><a href="#features" className="text-teal-200 hover:text-white transition">Features</a></li>
//                 <li><a href="#" className="text-teal-200 hover:text-white transition">Templates</a></li>
//                 <li><a href="#" className="text-teal-200 hover:text-white transition">Integrations</a></li>
//               </ul>
//             </div>
...
//               <ul className="space-y-2">
//                 <li><a href="#" className="text-teal-200 hover:text-white transition">Documentation</a></li>
//                 <li><a href="#" className="text-teal-200 hover:text-white transition">Guides</a></li>
//                 <li><a href="#" className="text-teal-200 hover:text-white transition">API</a></li>
//                 <li><a href="#faq" className="text-teal-200 hover:text-white transition">FAQ</a></li>
//               </ul>
//             </div>
...
//               <ul className="space-y-2">
//                 <li><a href="#" className="text-teal-200 hover:text-white transition">About</a></li>
//                 <li><a href="#" className="text-teal-200 hover:text-white transition">Blog</a></li>
//                 <li><a href="#" className="text-teal-200 hover:text-white transition">Careers</a></li>
//                 <li><a href="#" className="text-teal-200 hover:text-white transition">Contact</a></li>
//               </ul>
//             </div>
//           </div>
...
//               <a href="#" className="text-teal-200 hover:text-white transition">Terms</a>
//               <a href="#" className="text-teal-200 hover:text-white transition">Privacy</a>
//               <a href="#" className="text-teal-200 hover:text-white transition">Cookies</a>
//             </div>
//           </div>
//         </div>
//       </footer>
